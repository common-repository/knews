...
//print_r($users);
				...
				<div class="updated below-h2">
					...
					?> <a href="#" class="knews_blacklist"><?php _e('Look list','knews'); ?></a></p><p><a href="admin.php?page=knews_users&da=cleanBlackList" class="button"><?php _e('Run Mailing lists clean now','knews'); ?></a></p>
				</div>
