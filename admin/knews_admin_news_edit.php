...
?>
<script type="text/javascript">
	url_plugin = '<?php echo KNEWS_ADMIN_URL; ?>';
	...
	<?php
	if (defined('DEBUG_KNEWS_EDITOR') && DEBUG_KNEWS_EDITOR) {
		echo 'var debug_knews_editor=true; ';
	}
			...
			<span id="newstype">Type: <strong><?php echo $newstype; ?></strong> <a href="#">Change</a></span>
				...
				<div class="wysiwyg_toolbar">
					...
					<div class="image_properties">
						...
						<p><label><?php _e('Image link:','knews'); ?> <a href="#" title="<?php _e('Put a url if you want to put link around the image, for example: http://www.mysite.com/mypage.html.','knews'); ?>"><img src="<?php echo KNEWS_ADMIN_URL; ?>/images/help2.gif" width="16" height="16" alt="" /></a></label><input type="text" name="image_link" id="image_link" /></p>
						<p><label><?php _e('Image alt:','knews'); ?> <a href="#" title="<?php _e('The alternate text is very important, because most mail clients block initial image load and show the alternate image text.','knews'); ?>"><img src="<?php echo KNEWS_ADMIN_URL; ?>/images/help2.gif" width="16" height="16" alt="" /></a></label><textarea name="image_alt" id="image_alt"></textarea></p>
