...
?>
		...
		<a href="admin.php?page=knews_auto&tab=autoresponders" class="nav-tab"><?php _e('Autoresponders','knews'); ?></a></h2><br />
			...
			<form method="post" action="admin.php?page=knews_auto" id="create_auto">
				...
				<span id="auto_mode_2" <?php if ($f_auto_mode=='1') echo 'style="display:none;"'; ?>><label for="auto_time"><?php _e('Submit','knews'); ?></label> 
				<?php
				$f=0; $freq = array();
				...
				<div class="knews_radios_cat" <?php if ($cpt_checked) echo ' style="display:none"'; ?>>
					...
					?>
					<p>
					<input type="radio" name="knews_get_categories" value="all" <?php if ($f_cats=='all') echo 'checked="checked"'; ?> autocomplete="off" /> <?php _e('Get from all categories', 'knews'); ?><br />
					<input type="radio" name="knews_get_categories" value="include" <?php if ($f_cats=='include') echo 'checked="checked"'; ?> autocomplete="off" /> <?php _e('Get from this categories:', 'knews'); ?><br />
					<input type="radio" name="knews_get_categories" value="exclude" <?php if ($f_cats=='exclude') echo 'checked="checked"'; ?> autocomplete="off" /> <?php _e('Exclude this categories:', 'knews'); ?>
					</p>
