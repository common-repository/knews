// JavaScript Document
if (typeof debug_knews_editor == 'undefined') var debug_knews_editor=false;
...
function debug_alert(msg, data) {
	if (typeof data != 'undefined') {
		if (debug_knews_editor) console.log( msg + ' : ' + JSON.stringify(data));
	} else {
		if (debug_knews_editor) console.log( msg );
	}
}
